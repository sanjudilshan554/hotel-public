                            ...
                            <div class="single-footer-caption mb-50">
                                <div class="single-footer-caption mb-30">
                                    ...
                                    <div class="footer-logo mb-25">
                                        <a href="index.html"><img src="@/../src/img/logo/logo2_footer.png" alt=""></a>
                                    </div>
                                ...
                                <div class="footer-tittle">
                                    ...
                                    <ul>
                                        ...
                                        <li><a href="#"><span class="__cf_email__"
                                                    data-cfemail="87e4e8e9f3e6e4f3c7e4e6f5f0e6f4efa9e4e8ea">[email&#160;protected]</span></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                            ...
                            <div class="row d-flex align-items-center">
                                <div class="col-xl-12 ">
                                    <div class="footer-copy-right text-center">
                                        <p>Copyright &copy;All rights reserved | This template is made with <i
